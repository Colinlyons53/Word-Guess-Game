// words list
var words = ["JON", "DAENERYS", "NIGHTKING", "SANSA", "CERSEI", "JAIME", "TYRION", "ARYA"];
...
function isWinner() {
    ...
    if (ansWordArr.indexOf("_") === -1) {
        ...
        if(ansWord === "JON SNOW") {
            document.getElementById("giphy-embed").src = "https://giphy.com/embed/3og0IHyZMxZNkNOWT6";
        } else if (ansWord === "DAENERYS") {
            document.getElementById("giphy-embed").src = "";
        } else if (ansWord === "NIGHTKING") {
            document.getElementById("giphy-embed").src = "";
        } else if (ansWord === "SANSA") {
            document.getElementById("giphy-embed").src = "";
        } else if (ansWord === "CERSEI") {
            document.getElementById("giphy-embed").src = "";
        } else if (ansWord === "JAIME") {
            document.getElementById("giphy-embed").src = "";
        } else if (ansWord === "TYRION") {
            document.getElementById("giphy-embed").src = "https://giphy.com/embed/k5IO4hOxVS6pq" 
        } else if (ansWord === "ARYA") {
            document.getElementById("giphy-embed").src = "https://giphy.com/embed/k5IO4hOxVS6pq";
        }
